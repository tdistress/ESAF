...
- Draft the ARC-P100 enterprise AI platform and gateway pattern.
- Draft the ARC-P120 retrieval-augmented generation pattern.
- Draft the ARC-P130 agentic and multi-agent AI pattern.
- Draft the ARC-P160 AI observability pattern.
- Establish PCI DSS, HITRUST CSF, and UK Cyber Essentials crosswalk methodology.
