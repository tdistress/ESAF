...
## 0.17-draft publication

Publication gates are Closed. The `v0.17-draft` Working Draft was published
through annotated tag `v0.17-draft` on 2026-09-16. The tag object is
`e88e9ae36927b9a2dff0cbbeb53817ac635ce1a8` and its peeled commit is
`6732561fa6283797bdb27d990a5399dc905dd208`. Issue
[#208](https://github.com/tdistress/ESAF/issues/208) tracks the publication
gates. Post-merge validation evidence is
https://github.com/tdistress/ESAF/actions/runs/35158699486.
...
deepen packs at `0.3.0`, Phase 6 toolkit third deepen, NIST AI RMF `HOLD`,
...
equivalence, endorsement, assurance, or artifact lifecycle approval.

| Gate | Current state | Final evidence |
|---|---|---|
| Scope and milestone approval | Closed | https://github.com/tdistress/ESAF/issues/208 |
| Normative and technical review | Closed | https://github.com/tdistress/ESAF/issues/208 |
| Editorial and terminology review | Closed | https://github.com/tdistress/ESAF/issues/208 |
| Cross-reference and rendering review | Closed | https://github.com/tdistress/ESAF/issues/208 |
| Standards mapping review | Closed | https://github.com/tdistress/ESAF/issues/208 |
| Release metadata synchronization | Closed | https://github.com/tdistress/ESAF/issues/208 |
| Governance approval | Closed | https://github.com/tdistress/ESAF/issues/208 |
| Post-merge validation | Closed | https://github.com/tdistress/ESAF/actions/runs/35158699486 |

## 0.16-draft publication

Publication gates are Closed. The `v0.16-draft` Working Draft was published
through annotated tag `v0.16-draft` on 2026-09-16. The tag object is
`c4d41670de99b956ea1e41d7ce06ad427dce3bc0` and its peeled commit is
`b6a7547662720a0ea643f4a7766a75ff73af9a15`. Issue
[#196](https://github.com/tdistress/ESAF/issues/196) tracks the publication
gates. Post-merge validation evidence is
https://github.com/tdistress/ESAF/actions/runs/35149406927.

Publication is limited to the repository Working Draft. All controls,
architecture patterns, the pilot profile, mapping sets, and mapping records
remain Draft; their lifecycle records remain unchanged. Prerequisite
dispositions remain Phase 2 timing `DEFER`, ESAF-1300/1400/1700 Working Draft
deepen packs at `0.3.0`, Phase 6 toolkit second deepen, NIST AI RMF `HOLD`,
ISO/IEC 42001 `HOLD`, NIST CSF `HOLD`, ISO/IEC 27001 `HOLD`, NIST SP 800-53
...
| Gate | Current state | Final evidence |
|---|---|---|
| Scope and milestone approval | Closed | https://github.com/tdistress/ESAF/issues/196 |
| Normative and technical review | Closed | https://github.com/tdistress/ESAF/issues/196 |
| Editorial and terminology review | Closed | https://github.com/tdistress/ESAF/issues/196 |
| Cross-reference and rendering review | Closed | https://github.com/tdistress/ESAF/issues/196 |
| Standards mapping review | Closed | https://github.com/tdistress/ESAF/issues/196 |
| Release metadata synchronization | Closed | https://github.com/tdistress/ESAF/issues/196 |
| Governance approval | Closed | https://github.com/tdistress/ESAF/issues/196 |
| Post-merge validation | Closed | https://github.com/tdistress/ESAF/actions/runs/35149406927 |

## 0.15-draft publication

Publication gates are Closed. The `v0.15-draft` Working Draft was published
through annotated tag `v0.15-draft` on 2026-09-11. The tag object is
`63416236ddfa544d72f24534bb8742b31f4fe5f6` and its peeled commit is
`f006146dc037538478506d013801f7a357eaefa3`. Issue
[#185](https://github.com/tdistress/ESAF/issues/185) tracks the publication
gates. Post-merge validation evidence is
https://github.com/tdistress/ESAF/actions/runs/34646926085.
...
| Gate | Current state | Final evidence |
|---|---|---|
| Scope and milestone approval | Closed | https://github.com/tdistress/ESAF/issues/185 |
| Normative and technical review | Closed | https://github.com/tdistress/ESAF/issues/185 |
| Editorial and terminology review | Closed | https://github.com/tdistress/ESAF/issues/185 |
| Cross-reference and rendering review | Closed | https://github.com/tdistress/ESAF/issues/185 |
| Standards mapping review | Closed | https://github.com/tdistress/ESAF/issues/185 |
| Release metadata synchronization | Closed | https://github.com/tdistress/ESAF/issues/185 |
| Governance approval | Closed | https://github.com/tdistress/ESAF/issues/185 |
| Post-merge validation | Closed | https://github.com/tdistress/ESAF/actions/runs/34646926085 |
...
Publication gates are Closed. The `v0.13-draft` Working Draft was published
through annotated tag `v0.13-draft` on 2026-09-07. The tag object is
`1a220b7b62127c216d7e94bedf21686b82498b5a` and its peeled commit is
`ea2af64bc6fc2fe377a07d70bfbda777520dde70`. Issue
...
| Gate | Current state | Final evidence |
|---|---|---|
| Scope and milestone approval | Closed | https://github.com/tdistress/ESAF/issues/161 |
| Normative and technical review | Closed | https://github.com/tdistress/ESAF/issues/161 |
| Editorial and terminology review | Closed | https://github.com/tdistress/ESAF/issues/161 |
| Cross-reference and rendering review | Closed | https://github.com/tdistress/ESAF/issues/161 |
| Standards mapping review | Closed | https://github.com/tdistress/ESAF/issues/161 |
| Release metadata synchronization | Closed | https://github.com/tdistress/ESAF/issues/161 |
| Governance approval | Closed | https://github.com/tdistress/ESAF/issues/161 |
| Post-merge validation | Closed | https://github.com/tdistress/ESAF/actions/runs/34143551165 |

## 0.12-draft publication

Publication gates are Closed. The `v0.12-draft` Working Draft was published
through annotated tag `v0.12-draft` on 2026-09-07. The tag object is
`3c11c7a0261314ce9519a4e3f4cad9357a3fcbe6` and its peeled commit is
`6546f2cacbbfaa89c7828991768e623b42a8081d`. Issue
...
remain Draft; their lifecycle records remain unchanged. Prerequisite
dispositions remain Phase 2 timing `DEFER`, ESAF-1300/1400/1700 Working
Drafts, NIST AI RMF `HOLD`, ISO/IEC 42001 `HOLD`, and the ESAF-1000/1100
Working Draft deepen packs. Issues 55 and 60 remain open. Publication does
not establish certification, compliance, equivalence, endorsement, assurance,
or artifact lifecycle approval.

| Gate | Current state | Final evidence |
|---|---|---|
| Scope and milestone approval | Closed | https://github.com/tdistress/ESAF/issues/146 |
| Normative and technical review | Closed | https://github.com/tdistress/ESAF/issues/146 |
| Editorial and terminology review | Closed | https://github.com/tdistress/ESAF/issues/146 |
| Cross-reference and rendering review | Closed | https://github.com/tdistress/ESAF/issues/146 |
| Standards mapping review | Closed | https://github.com/tdistress/ESAF/issues/146 |
| Release metadata synchronization | Closed | https://github.com/tdistress/ESAF/issues/146 |
| Governance approval | Closed | https://github.com/tdistress/ESAF/issues/146 |
| Post-merge validation | Closed | https://github.com/tdistress/ESAF/actions/runs/34094275390 |

## 0.11-draft publication

Publication gates are Closed. The `v0.11-draft` Working Draft was published
through annotated tag `v0.11-draft` on 2026-09-06. The tag object is
`d810eeef96fd8bef2bd7fa905eb719f10c53a4c7` and its peeled commit is
`0afbf963a6c11ee1feb65384b8e685461fe2dc85`. Issue
...
remain Draft; their lifecycle records remain unchanged. Prerequisite
dispositions remain Phase 2 timing `DEFER`, ESAF-1300/1400/1700 Working
Drafts, NIST AI RMF `HOLD`, and the Phase 6 Draft toolkit deepen packs. Issues 55
and 60 remain open. Publication does not establish certification,
compliance, equivalence, endorsement, assurance, or artifact lifecycle
approval.

| Gate | Current state | Final evidence |
|---|---|---|
| Scope and milestone approval | Closed | https://github.com/tdistress/ESAF/issues/129 |
| Normative and technical review | Closed | https://github.com/tdistress/ESAF/issues/129 |
| Editorial and terminology review | Closed | https://github.com/tdistress/ESAF/issues/129 |
| Cross-reference and rendering review | Closed | https://github.com/tdistress/ESAF/issues/129 |
| Standards mapping review | Closed | https://github.com/tdistress/ESAF/issues/129 |
| Release metadata synchronization | Closed | https://github.com/tdistress/ESAF/issues/129 |
| Governance approval | Closed | https://github.com/tdistress/ESAF/issues/129 |
| Post-merge validation | Closed | https://github.com/tdistress/ESAF/actions/runs/34015401644 |

## 0.10-draft publication

Publication gates are Closed. The `v0.10-draft` Working Draft was published
through annotated tag `v0.10-draft` on 2026-09-05. The tag object is
`7f982082d20e600863c0b564408d4591dfebcbc7` and its peeled commit is
`05b7ebdd588d9959412fce1d2d4d9bdf663e998e`. Issue
...
| Gate | Current state | Final evidence |
|---|---|---|
| Scope and milestone approval | Closed | https://github.com/tdistress/ESAF/issues/119 |
| Normative and technical review | Closed | https://github.com/tdistress/ESAF/issues/119 |
| Editorial and terminology review | Closed | https://github.com/tdistress/ESAF/issues/119 |
| Cross-reference and rendering review | Closed | https://github.com/tdistress/ESAF/issues/119 |
| Standards mapping review | Closed | https://github.com/tdistress/ESAF/issues/119 |
| Release metadata synchronization | Closed | https://github.com/tdistress/ESAF/issues/119 |
| Governance approval | Closed | https://github.com/tdistress/ESAF/issues/119 |
| Post-merge validation | Closed | https://github.com/tdistress/ESAF/actions/runs/33980540911 |
