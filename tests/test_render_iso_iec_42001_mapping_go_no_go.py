...
import tools.render_iso_iec_42001_mapping_go_no_go as renderer
from tools.render_iso_iec_42001_mapping_go_no_go import (
    derive_decision,
    render,
    validate_matrix,
)
...
TOOL = ROOT / "tools" / "render_iso_iec_42001_mapping_go_no_go.py"
...
RIGHTS_COMMIT = "a7a5c890f41fdda6c846a79ed57020314ee979e8"


class IsoIec42001MappingGoNoGoTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_rights_review_rejects_wrong_path(self) -> None:
        ...
        wrong_path["rights_review"]["path"] = "tests/test_iso_iec_42001_source_readiness.py"
    ...
    def test_reviewer_contract_requires_qualified_independent_exact_sha_reviews(self) -> None:
        ...
        self.assertEqual(
            contract["mapper"],
            {
                ...
                "experience_required": ["ISO/IEC 42001:2023", "ESAF-1600"],
        ...
        self.assertEqual(
            reviewers["iso_iec_42001_subject_matter"]["qualification"],
            "owner-approved ISO/IEC 42001:2023 subject-matter reviewer",
        )
    ...
    def test_render_is_deterministic_and_covers_hold_contract(self) -> None:
        ...
        self.assertIn("# ISO/IEC 42001:2023 mapping readiness decision", rendered)
