...
class Esaf1600FoundationTests(unittest.TestCase):
    ...
    def assert_cis_controls_hold_landing_page(self, text: str) -> None:
        normalized = normalize_markdown_contract(text)
        statuses = re.findall(
            r"(?m)^\*\*Status:\*\*\s*(\S.*?)\s*$",
            normalized,
        ...
        self.assertIn("[ESAF-1600](ESAF-1600.md)", normalized)
        self.assertIn("CIS Controls mapping artifacts: `0`", normalized)
        self.assertNotRegex(
            normalized,
            r"(?im)^## Approved mappings$|"
            r"^\| External provision \| ESAF control \|$|"
            r"CIS Controls .+ maps directly",
        )
    ...
    def test_unmapped_landing_pages_publish_readiness_and_link_methodology(self) -> None:
        ...
        self.assert_cis_controls_hold_landing_page(cis_controls)
    ...
    def assert_ci_workflow_contract(self, workflow: dict[str, object]) -> None:
        ...
        expected_paths = [
            ...
            "tools/v011_draft_release_gates.py",
            "tests/test_v011_draft_release_gates.py",
            "tools/v012_draft_release_gates.py",
            "tests/test_v012_draft_release_gates.py",
            "tools/v013_draft_release_gates.py",
            "tests/test_v013_draft_release_gates.py",
            "tools/v014_draft_release_gates.py",
            "tests/test_v014_draft_release_gates.py",
            "tools/v015_draft_release_gates.py",
            "tests/test_v015_draft_release_gates.py",
            "tools/v016_draft_release_gates.py",
            ...
            "docs/superpowers/reviews/2026-09-10-v014-draft-publication-readiness.md",
            "docs/superpowers/reviews/2026-09-11-v015-draft-publication-readiness.md",
            "docs/superpowers/reviews/2026-09-16-v016-draft-publication-readiness.md",
            "docs/superpowers/reviews/2026-09-16-v017-draft-publication-readiness.md",
        ...
        nist_csf_readiness = unique_step("Validate NIST CSF readiness review")
        self.assertEqual(nist_csf_readiness, {
            "name": "Validate NIST CSF readiness review",
            "run": "python tools/render_nist_csf_mapping_go_no_go.py --check",
        })

        nist_sp_800_53_readiness = unique_step("Validate NIST SP 800-53 readiness review")
        ...
        iso_27001_readiness = unique_step("Validate ISO/IEC 27001 readiness review")
        self.assertEqual(iso_27001_readiness, {
            "name": "Validate ISO/IEC 27001 readiness review",
            "run": "python tools/render_iso_iec_27001_mapping_go_no_go.py --check",
        })
        ...
        v011_draft_pr = unique_step(
            "Validate v0.11-draft release record on pull request"
        )
        self.assertEqual(v011_draft_pr, {
            "name": "Validate v0.11-draft release record on pull request",
            "if": "github.event_name == 'pull_request'",
            "run": (
        ...
        v011_draft_push = unique_step(
            "Validate v0.11-draft release record on protected-branch push"
        )
        self.assertEqual(v011_draft_push, {
            "name": "Validate v0.11-draft release record on protected-branch push",
            "if": "github.event_name == 'push'",
            "run": (
                "python tools/v011_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.before }}"'
        ...
        v011_draft_dispatch = unique_step(
            "Validate v0.11-draft release record on workflow dispatch"
        )
        self.assertEqual(v011_draft_dispatch, {
            "name": "Validate v0.11-draft release record on workflow dispatch",
            "if": "github.event_name == 'workflow_dispatch'",
            "run": (
                "python tools/v011_draft_release_gates.py --check "
                '--baseline-ref "HEAD^"'
        ...
        v012_draft_pr = unique_step(
            "Validate v0.12-draft release record on pull request"
        )
        self.assertEqual(v012_draft_pr, {
            "name": "Validate v0.12-draft release record on pull request",
            "if": "github.event_name == 'pull_request'",
            "run": (
                "python tools/v012_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.pull_request.base.sha }}"'
            ),
        })
        v012_draft_push = unique_step(
            "Validate v0.12-draft release record on protected-branch push"
        )
        self.assertEqual(v012_draft_push, {
            "name": "Validate v0.12-draft release record on protected-branch push",
            "if": "github.event_name == 'push'",
            "run": (
                "python tools/v012_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.before }}"'
        ...
        v012_draft_dispatch = unique_step(
            "Validate v0.12-draft release record on workflow dispatch"
        )
        self.assertEqual(v012_draft_dispatch, {
            "name": "Validate v0.12-draft release record on workflow dispatch",
            "if": "github.event_name == 'workflow_dispatch'",
            "run": (
                "python tools/v012_draft_release_gates.py --check "
                '--baseline-ref "HEAD^"'
        ...
        v013_draft_pr = unique_step(
            "Validate v0.13-draft release record on pull request"
        )
        self.assertEqual(v013_draft_pr, {
            "name": "Validate v0.13-draft release record on pull request",
            "if": "github.event_name == 'pull_request'",
            "run": (
                "python tools/v013_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.pull_request.base.sha }}"'
            ),
        })
        v013_draft_push = unique_step(
            "Validate v0.13-draft release record on protected-branch push"
        )
        self.assertEqual(v013_draft_push, {
            "name": "Validate v0.13-draft release record on protected-branch push",
            "if": "github.event_name == 'push'",
            "run": (
                "python tools/v013_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.before }}"'
        ...
        v013_draft_dispatch = unique_step(
            "Validate v0.13-draft release record on workflow dispatch"
        )
        self.assertEqual(v013_draft_dispatch, {
            "name": "Validate v0.13-draft release record on workflow dispatch",
            "if": "github.event_name == 'workflow_dispatch'",
            "run": (
                "python tools/v013_draft_release_gates.py --check "
                '--baseline-ref "HEAD^"'
        ...
        v014_draft_pr = unique_step(
            "Validate v0.14-draft release record on pull request"
        )
        self.assertEqual(v014_draft_pr, {
            "name": "Validate v0.14-draft release record on pull request",
            "if": "github.event_name == 'pull_request'",
            "run": (
        ...
        v014_draft_push = unique_step(
            "Validate v0.14-draft release record on protected-branch push"
        )
        self.assertEqual(v014_draft_push, {
            "name": "Validate v0.14-draft release record on protected-branch push",
            "if": "github.event_name == 'push'",
            "run": (
                "python tools/v014_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.before }}"'
        ...
        v014_draft_dispatch = unique_step(
            "Validate v0.14-draft release record on workflow dispatch"
        )
        self.assertEqual(v014_draft_dispatch, {
            "name": "Validate v0.14-draft release record on workflow dispatch",
            "if": "github.event_name == 'workflow_dispatch'",
            "run": (
                "python tools/v014_draft_release_gates.py --check "
                '--baseline-ref "HEAD^"'
        ...
        v015_draft_pr = unique_step(
            "Validate v0.15-draft release record on pull request"
        )
        self.assertEqual(v015_draft_pr, {
            "name": "Validate v0.15-draft release record on pull request",
            "if": "github.event_name == 'pull_request'",
            "run": (
                "python tools/v015_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.pull_request.base.sha }}"'
            ),
        })
        v015_draft_push = unique_step(
            "Validate v0.15-draft release record on protected-branch push"
        )
        self.assertEqual(v015_draft_push, {
            "name": "Validate v0.15-draft release record on protected-branch push",
            "if": "github.event_name == 'push'",
            "run": (
                "python tools/v015_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.before }}"'
        ...
        v015_draft_dispatch = unique_step(
            "Validate v0.15-draft release record on workflow dispatch"
        )
        self.assertEqual(v015_draft_dispatch, {
            "name": "Validate v0.15-draft release record on workflow dispatch",
            "if": "github.event_name == 'workflow_dispatch'",
            "run": (
                "python tools/v015_draft_release_gates.py --check "
                '--baseline-ref "HEAD^"'
        ...
        v016_draft_pr = unique_step(
            "Validate v0.16-draft release record on pull request"
        )
        self.assertEqual(v016_draft_pr, {
            "name": "Validate v0.16-draft release record on pull request",
            "if": "github.event_name == 'pull_request'",
            "run": (
                "python tools/v016_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.pull_request.base.sha }}"'
            ),
        })
        v016_draft_push = unique_step(
            "Validate v0.16-draft release record on protected-branch push"
        )
        self.assertEqual(v016_draft_push, {
            "name": "Validate v0.16-draft release record on protected-branch push",
            "if": "github.event_name == 'push'",
            "run": (
                "python tools/v016_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.before }}"'
        ...
        v016_draft_dispatch = unique_step(
            "Validate v0.16-draft release record on workflow dispatch"
        )
        self.assertEqual(v016_draft_dispatch, {
            "name": "Validate v0.16-draft release record on workflow dispatch",
            "if": "github.event_name == 'workflow_dispatch'",
            "run": (
                "python tools/v016_draft_release_gates.py --check "
                '--baseline-ref "HEAD^"'
        ...
        v017_draft_pr = unique_step(
            "Validate v0.17-draft release record on pull request"
        )
        self.assertEqual(v017_draft_pr, {
            "name": "Validate v0.17-draft release record on pull request",
            "if": "github.event_name == 'pull_request'",
            "run": (
        ...
        v017_draft_push = unique_step(
            "Validate v0.17-draft release record on protected-branch push"
        )
        self.assertEqual(v017_draft_push, {
            "name": "Validate v0.17-draft release record on protected-branch push",
            "if": "github.event_name == 'push'",
            "run": (
                "python tools/v017_draft_release_gates.py --check "
                '--baseline-ref "${{ github.event.before }}"'
        ...
        v017_draft_dispatch = unique_step(
            "Validate v0.17-draft release record on workflow dispatch"
        )
        self.assertEqual(v017_draft_dispatch, {
            "name": "Validate v0.17-draft release record on workflow dispatch",
            "if": "github.event_name == 'workflow_dispatch'",
            "run": (
                "python tools/v017_draft_release_gates.py --check "
                '--baseline-ref "HEAD^"'
