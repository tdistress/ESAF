...
_ROLE_CASES: tuple[QualifiedReviewPolicyCase, ...] = (
    ...
    QualifiedReviewPolicyCase("test_actor_aliases_and_shared_locator_cannot_bypass_role_rules", "actor-alias:case", "role_readiness", "draft", (_operation(("mapping_sets", 0, "roles", 1, "reviewer", "identity"), "CORE INVENTORY REVIEWER"),), _report(False, False, errors=_error("duplicate reviewer lacks complete dual-role acceptance and qualifications"))),
    QualifiedReviewPolicyCase("test_actor_aliases_and_shared_locator_cannot_bypass_role_rules", "actor-alias:punctuation", "role_readiness", "draft", (_operation(("mapping_sets", 0, "roles", 1, "reviewer", "identity"), "core-inventory-reviewer"),), _report(False, False, errors=_error("duplicate reviewer lacks complete dual-role acceptance and qualifications"))),
    ...
    QualifiedReviewPolicyCase("test_actor_aliases_and_shared_locator_cannot_bypass_role_rules", "actor-alias:shared-locator", "role_readiness", "draft", (_operation(("mapping_sets", 0, "roles", 1, "reviewer", "identity"), "Different Display Name"), _operation(("mapping_sets", 0, "roles", 1, "reviewer", "verification_locator"), "https://identity.example.invalid/reviewer?version=core-inventory")), _report(False, False, errors=_error("duplicate reviewer lacks complete dual-role acceptance and qualifications"))),
