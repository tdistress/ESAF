...
import tools.render_iso_iec_27001_mapping_go_no_go as renderer
from tools.render_iso_iec_27001_mapping_go_no_go import (
    derive_decision,
    render,
    validate_matrix,
)
...
TOOL = ROOT / "tools" / "render_iso_iec_27001_mapping_go_no_go.py"
...
class IsoIec27001MappingGoNoGoTests(unittest.TestCase):
    ...
    def test_rights_review_rejects_wrong_path(self) -> None:
        ...
        wrong_path["rights_review"]["path"] = "tests/test_iso_iec_27001_source_readiness.py"
    ...
    def test_reviewer_contract_requires_qualified_independent_exact_sha_reviews(self) -> None:
        ...
        self.assertEqual(
            contract["mapper"],
            {
                ...
                "experience_required": ["ISO/IEC 27001:2022", "ESAF-1600"],
        ...
        self.assertEqual(
            reviewers["iso_iec_27001_subject_matter"]["qualification"],
            "owner-approved ISO/IEC 27001:2022 subject-matter reviewer",
        )
    ...
    def test_render_is_deterministic_and_covers_hold_contract(self) -> None:
        ...
        self.assertIn("# ISO/IEC 27001:2022 mapping readiness decision", rendered)
