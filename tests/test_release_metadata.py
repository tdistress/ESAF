...
# These digests pin immutable post-merge synchronization payloads. Any reviewed
# edit must intentionally repin the corresponding literal.
PINNED_RELEASE_PLAN_DEFERRED_ASSURANCE_SHA256 = (
    "d007b455190fc620d0f0030cbe27f321a37679abe2f0ce5368174f1615d85c28"
)
PINNED_PLANNED_ISSUE_55_BODY_SHA256 = (
    "359c9c2c1267f6a75c084196673735c7c296f3af372f0ba51efa88a53417f0ad"
)
...
V013_NEXT_STEPS_PLAN = (
    "docs/superpowers/plans/2026-09-07-v013-draft-next-steps.md"
)
PINNED_V013_ISSUE_A_BODY_SHA256 = (
    "b2ebe770f9311b801db56e718225fbd68db6e44614378f257f5ad1975fea0482"
)
PINNED_V013_ISSUE_B_BODY_SHA256 = (
    "30533645cc72d25d562ad471daf1b91ed2cc2937e51dc9701fdc3dda9d974bf6"
)
PINNED_V013_ISSUE_C_BODY_SHA256 = (
    "eead54227a8d91c8d63dddf0e303212489d0c5a1e65f361563e718c391ce3f50"
)
PINNED_V013_ISSUE_D_BODY_SHA256 = (
    "fb9340841435d73910548570dcb3bc67b6fcba6c1c5d1c8e838dffd754f8c3ad"
)
V013_READY_ISSUE_TASKS = (
    (
        "## Task 4: Ready-to-file Issue A - tracker hygiene",
    ...
    (
        ...
        (
            "Issues #55 and #60 may remain open",
            "Every `v0.13-draft` exit criterion",
            "Working Draft",
        ),
    ),
)

V014_NEXT_STEPS_PLAN = (
    "docs/superpowers/plans/2026-09-10-v014-draft-next-steps.md"
)
PINNED_V014_ISSUE_A_BODY_SHA256 = (
    "6e3bef240edb3ecce8963aa6a9af24cb565663210472b5178faa822f8d3cbb6f"
)
PINNED_V014_ISSUE_B_BODY_SHA256 = (
    "1c1bbf229670ad936f61b590be1f0a355115ea80e527f922786d0e1cd395daaf"
)
PINNED_V014_ISSUE_C_BODY_SHA256 = (
    "47d091dd32d0de7ad02331ce94a7837c9c15a7353090dd8faafc33cb5dccb908"
)
V014_READY_ISSUE_TASKS = (
    (
        "## Task 4: Ready-to-file Issue A - tracker hygiene",
    ...
    (
        ...
        (
            "Issues #55 and #60 may remain open",
            "Every `v0.14-draft` exit criterion",
            "Working Draft",
        ),
    ),
)
...
V015_NEXT_STEPS_PLAN = (
    "docs/superpowers/plans/2026-09-11-v015-draft-next-steps.md"
)
PINNED_V015_ISSUE_A_BODY_SHA256 = (
    "054c611745d96aa90d3b9979a9c764aed5c30a032538cad1cd2c7edc784a65c6"
)
PINNED_V015_ISSUE_B_BODY_SHA256 = (
    "d9d9e2960fb3d8387b64d7ce53ffbf283fcd7932ee29844737be2bfb46a84dcf"
)
PINNED_V015_ISSUE_C_BODY_SHA256 = (
    "76044258ade8c10ce02341bd59fbc25dc90a7b90c4b7608db2f1aad3b3df50d5"
)
PINNED_V015_ISSUE_D_BODY_SHA256 = (
    "82202492e545423d708f0d2b0dc34b9947a9a0b75f5cd6be9f328351b13c1a47"
)
PINNED_V015_ISSUE_E_BODY_SHA256 = (
    "f07299eed8346109cef73d8000aa0a87b72d8d3af60aab2aa7941557e16360fb"
)
V015_READY_ISSUE_TASKS = (
    (
        "## Task 4: Ready-to-file Issue A - tracker hygiene",
    ...
    (
        ...
        (
            "Issues #55 and #60 may remain open",
            "Every `v0.15-draft` exit criterion",
            "Working Draft",
        ),
    ),
)
...
class ReleaseMetadataTests(unittest.TestCase):
    ...
    def test_release_plan_allows_one_uniform_mapping_decision_basis(self) -> None:
        ...
        self.assertEqual(
            PINNED_RELEASE_PLAN_DEFERRED_ASSURANCE_SHA256,
            sha256_text(assurance),
        )

    def test_release_plan_pinned_artifact_rejects_adversarial_mutations(
        self,
    ) -> None:
        release_plan = read_repository_file("project/RELEASE_PLAN.md")
        assurance = markdown_section(
        ...
        mutations = (
            ...
            "Owner-risk acceptance is the selected path. It establishes compliance.",
            "The deferred disposition applies. This establishes qualified-review "
            "assurance.",
            "Owner-risk acceptance establishes regulatory conformity.",
            "Readiness for production is demonstrated by the owner-risk decision.",
        )
        for mutation in mutations:
            with self.subTest(mutation=mutation):
                self.assertNotEqual(
                    PINNED_RELEASE_PLAN_DEFERRED_ASSURANCE_SHA256,
                    sha256_text(f"{assurance}\n\n{mutation}"),
                )

    def test_issue_55_pinned_artifact_rejects_adversarial_relationship_mutation(
        self,
    ) -> None:
        ...
        self.assertNotEqual(
            PINNED_PLANNED_ISSUE_55_BODY_SHA256,
            sha256_text(f"{issue_body}\n\n{mutation}"),
        )

    def test_issue_55_pinned_artifact_rejects_adversarial_state_mutations(
        self,
    ) -> None:
        plan = read_repository_file(
            "docs/superpowers/plans/"
        ...
        mutations = (
            ...
            "Issue 55 is resolved.",
            "This issue is finished.",
            "#55 has been concluded.",
            "Issue 55 will be archived.",
        )
        for mutation in mutations:
            with self.subTest(mutation=mutation):
                self.assertNotEqual(
    ...
    def test_issue_59_pinned_artifact_rejects_adversarial_state_mutations(
        self,
    ) -> None:
        plan = read_repository_file(
            "docs/superpowers/plans/"
    ...
    def test_v013_draft_has_bounded_workstreams_and_exit_criteria(self) -> None:
        milestones = read_repository_file("project/MILESTONES.md")
        section = milestone_section(milestones, "## v0.13-draft")
        for heading in (
            "### Entry state",
            "### Required workstreams",
            "### Exit criteria",
        ...
        for required in (
            "Tracker hygiene",
            "NIST CSF 2.0 public-source readiness",
            "ESAF-1200 normative deepen",
            "Release closure",
            "Issues `#142`–`#146`",
            "Critical and Important",
        ):
    ...
    def test_v013_draft_preserves_bounded_non_goals(self) -> None:
        milestones = read_repository_file("project/MILESTONES.md")
        section = milestone_section(milestones, "## v0.13-draft")
        non_goals = section[section.index("### Non-goals"):]
        for non_goal in (
            ...
            "authoring ISO/IEC 42001 mapping records",
            "non-`GO`",
            "authoring NIST CSF mapping records",
            "all roadmap crosswalks",
            "all planned profiles",
            "redesigning `v1.0`",
        ):
    ...
    def test_backlog_records_post_v012_v013_draft_initiatives(self) -> None:
        backlog = read_repository_file("project/BACKLOG.md")
        queue = markdown_section(backlog, "## Post-v0.12 scheduled queue")
        for required in (
            "Sync post-v0.12 tracker hygiene",
            "Complete NIST CSF 2.0 public-source readiness and mapping go/no-go",
            "Deepen ESAF-1200 Reference Architecture Working Draft",
    ...
    def test_roadmap_records_v013_draft_delivery_sequence(self) -> None:
        roadmap = read_repository_file("ROADMAP.md")
        sequence = markdown_section(
            roadmap,
    ...
    def test_planned_v013_issue_bodies_preserve_boundaries_and_digests(self) -> None:
        plan = read_repository_file(V013_NEXT_STEPS_PLAN)
        for task_heading, title, digest, required_phrases in V013_READY_ISSUE_TASKS:
            with self.subTest(title=title):
                self.assertIn(f"Title: `{title}`", plan)
                body = fenced_markdown_in_task(plan, task_heading)
                for required in required_phrases:
    ...
    def test_v014_draft_has_bounded_workstreams_and_exit_criteria(self) -> None:
        milestones = read_repository_file("project/MILESTONES.md")
        section = milestone_section(milestones, "## v0.14-draft")
        for heading in (
            "### Entry state",
            "### Required workstreams",
            "### Exit criteria",
    ...
    def test_v014_draft_preserves_bounded_non_goals(self) -> None:
        milestones = read_repository_file("project/MILESTONES.md")
        section = milestone_section(milestones, "## v0.14-draft")
        non_goals = section[section.index("### Non-goals"):]
        for non_goal in (
            ...
            "ISO/IEC 42001 `HOLD`",
            "NIST CSF `HOLD`",
            "new public-source readiness workstream",
            "all roadmap crosswalks",
            "all planned profiles",
            "redesigning `v1.0`",
        ):
    ...
    def test_backlog_records_post_v013_v014_draft_initiatives(self) -> None:
        backlog = read_repository_file("project/BACKLOG.md")
        queue = markdown_section(backlog, "## Post-v0.13 scheduled queue")
        for required in (
            "Sync post-v0.13 tracker hygiene",
            "Deepen ESAF-1500 Assessment Guide Working Draft",
            "Close the v0.14-draft publication gates",
    ...
    def test_roadmap_records_v014_draft_delivery_sequence(self) -> None:
        roadmap = read_repository_file("ROADMAP.md")
        sequence = markdown_section(
            roadmap,
        ...
        for required in (
            ...
            "issue 60",
            "does not stop later engineering work",
            "not `v0.14-draft` exit criteria",
            "Phases 4, 5, and 6",
        ):
            with self.subTest(required=required):
                self.assertTrue(contains_normalized_phrase(sequence, required))

    def test_planned_v014_issue_bodies_preserve_boundaries_and_digests(self) -> None:
        plan = read_repository_file(V014_NEXT_STEPS_PLAN)
        for task_heading, title, digest, required_phrases in V014_READY_ISSUE_TASKS:
            with self.subTest(title=title):
                self.assertIn(f"Title: `{title}`", plan)
                body = fenced_markdown_in_task(plan, task_heading)
                for required in required_phrases:
    ...
    def test_v015_draft_has_bounded_workstreams_and_exit_criteria(self) -> None:
        milestones = read_repository_file("project/MILESTONES.md")
        section = milestone_section(milestones, "## v0.15-draft")
        for heading in (
            "### Entry state",
            "### Required workstreams",
            "### Exit criteria",
    ...
    def test_v015_draft_preserves_bounded_non_goals(self) -> None:
        milestones = read_repository_file("project/MILESTONES.md")
        section = milestone_section(milestones, "## v0.15-draft")
        non_goals = section[section.index("### Non-goals"):]
        for non_goal in (
    ...
    def test_backlog_records_post_v014_v015_draft_initiatives(self) -> None:
        backlog = read_repository_file("project/BACKLOG.md")
        queue = markdown_section(backlog, "## Post-v0.14 scheduled queue")
        for required in (
            "Sync post-v0.14 tracker hygiene",
            "Complete ISO/IEC 27001:2022 public-source readiness and mapping go/no-go",
            "Deepen Phase 6 assessment toolkit Draft packs",
    ...
    def test_roadmap_records_v015_draft_delivery_sequence(self) -> None:
        roadmap = read_repository_file("ROADMAP.md")
        sequence = markdown_section(
            roadmap,
