...
RENDERER = ROOT / "tools" / "render_nist_sp_800_53_mapping_go_no_go.py"
MATRIX = (
    ROOT
    / "docs"
    / "superpowers"
...
class RenderNistSp80053MappingGoNoGoTests(unittest.TestCase):
    @classmethod
    ...
    def test_rendered_review_is_hold(self) -> None:
        ...
        self.assertIn("`NIST-SP-800-53-READINESS-B001`", text)
