# ISO/IEC 27001:2022 source readiness and mapping decision design

## Purpose

ESAF shall decide whether a public ISO/IEC 27001:2022 mapping may proceed by
...
27001:2022 is identifiable as the target publication, but the authorized source
...
- `docs/superpowers/specs/2026-09-11-iso-iec-27001-source-readiness-oracle.json`
- `docs/superpowers/reviews/2026-09-11-iso-iec-27001-publication-rights-review.md`
...
- `docs/superpowers/reviews/2026-09-11-iso-iec-27001-2022-mapping-go-no-go-review.md`
- `docs/superpowers/reviews/2026-09-11-iso-iec-27001-2022-mapping-go-no-go-traceability.md`
- focused source-readiness and renderer tests
- `crosswalks/iso-iec-27001.md` landing page

No file shall be created under `crosswalks/mappings/` or
`crosswalks/registry/`. No ISO/IEC 27001 provision inventory JSON shall exist.
...
> one authorized, publishable ISO/IEC 27001:2022 clause or control outcome,
...
Blockers `ISO-IEC-27001-READINESS-B001` through `B005` mirror the PCI
...
A future GO requires a named mapper with ISO/IEC 27001:2022 and ESAF-1600
experience, plus independent reviewers for `iso_iec_27001_subject_matter`,
...
`I182-*` traceability. `crosswalks/iso-iec-27001.md` shall publish the HOLD
