# Cyber Essentials Plus v3.2 external-to-ESAF mapping rights attestation
...
The independent reviewer authorizes publication of the reverse mapping under the
stated licence and attribution only for the listed field classes. This decision
binds the exact keyed oracle and both official NCSC PDF byte variants. It excludes
copied source passages, IASME-derived structure, marks, imagery, and any inference
about the current operational scheme. The approval is unconditional within these
