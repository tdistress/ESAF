...
- Filled fictional examples:
  ...
  - [`examples/catalog3-record.example.json`](examples/catalog3-record.example.json)
  - [`examples/catalog3-configuration.example.json`](examples/catalog3-configuration.example.json)
  - [`examples/catalog3-observation.example.json`](examples/catalog3-observation.example.json)
  - [`examples/catalog3-contract.example.json`](examples/catalog3-contract.example.json)
  - [`examples/catalog3-external-assurance.example.json`](examples/catalog3-external-assurance.example.json)
  - [`examples/catalog3-other.example.json`](examples/catalog3-other.example.json)
