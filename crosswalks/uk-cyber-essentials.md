...
The [Cyber Essentials Plus v3.2 forward-mapping snapshot](mappings/uk-ncsc/cyber-essentials-plus-test-specification/3.2/0.4-alpha/0.1.0/README.md) is a complete-publication, unqualified technical draft. Its 144 records contain 8 relationship legs referencing 7 distinct controls and 137 no-direct-mapping dispositions. Complete-publication means inventory coverage of the pinned public v3.2 source only; it is not the current operational scheme and does not establish assessment execution, observed results, aggregate sufficiency, certification, compliance, equivalence, current-scheme completeness, qualified review, full-population assurance, or continuous assurance.

The [Cyber Essentials Plus v3.2 external-to-ESAF snapshot](mappings/uk-ncsc/cyber-essentials-plus-test-specification/3.2/0.4-alpha/0.2.0/README.md) is a separate complete-publication, unqualified technical draft. Its 144 records contain 32 mapped provisions, 32 relationship legs referencing 10 distinct controls, and 112 no-direct-mapping dispositions. Each reverse-only `external_to_esaf` leg records a bounded, point-in-time observation of one exact normative ESAF requirement. The snapshot is not the current operational scheme and does not establish assessment execution, certification, compliance, equivalence, implementation, effectiveness, aggregate sufficiency, current-scheme completeness, full-population assurance, or continuous assurance. Its lifecycle remains draft with no transition event, and qualified SME review remains future work.

## Cyber Essentials Plus v3.2 mapping feasibility

The [canonical feasibility matrix](../docs/superpowers/specs/2026-07-15-uk-cyber-essentials-plus-v3.2-mapping-feasibility-matrix.json) and [rendered decision record](../docs/superpowers/reviews/2026-07-15-uk-cyber-essentials-plus-v3.2-mapping-go-no-go-review.md) record these directional dispositions: `esaf_to_external`: **GO** and `external_to_esaf`: **GO**. At feasibility-decision time: No Cyber Essentials Plus mapping exists. No Cyber Essentials Plus mapping snapshot exists. `GO` authorizes design only; it did not authorize mapping implementation. The repository owner's separate execution authorization permitted the forward draft above. At that feasibility-decision time, the `external_to_esaf` direction remained a separate, source-versioned design item and had not been implemented.

These feasibility-time decisions apply only to the pinned public Cyber Essentials Plus v3.2 specification. They do not establish completeness for the current operational Cyber Essentials Plus scheme or change the source and assurance boundaries above. Both separately authorized directional designs have since been implemented as the distinct draft snapshots linked above; that later work does not change the historical decision record or promote either lifecycle.
