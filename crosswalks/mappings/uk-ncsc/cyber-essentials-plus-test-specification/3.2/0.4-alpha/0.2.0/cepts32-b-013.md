---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Use executable test files with conspicuous behavior so execution is quickly and easily observable."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 23; printed page 22; Appendix B: Types of test file; continued guidance, executable behavior"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-B-013 - external result \u0027conspicuous behavior\u0027 does not evidence ESAF outcome \u0027an observed execution-control result for an executable on an in-scope AI host\u0027.",
    "mapper":  {
