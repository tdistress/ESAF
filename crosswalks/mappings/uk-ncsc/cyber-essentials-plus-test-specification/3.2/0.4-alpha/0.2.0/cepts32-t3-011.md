---
{
  ...
  "context": {
    "mode": "paraphrase",
    "summary": "Create a separate assessment email and attachment for every selected file type."
  },
  "source_locator": {
    ...
    "locator": "PDF page 14; printed page 13; Test case 3; test-email preparation"
  },
  "disposition": "no_direct_mapping",
  "relationships": [],
  "negative_rationale": "Missing outcome: CEPTS3.2-T3-011 - external result 'assessment email and attachment' does not evidence ESAF outcome 'observed malware-file prevention result for an AI-supporting host or service'.",
  "mapper": {
