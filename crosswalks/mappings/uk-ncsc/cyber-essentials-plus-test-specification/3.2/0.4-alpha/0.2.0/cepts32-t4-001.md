---
{
  ...
  "context": {
    "mode": "paraphrase",
    "summary": "Perform Test case 4 on every cloud service."
  },
  "source_locator": {
    ...
    "locator": "PDF page 17; printed page 16; Test case 4; unheaded applicability line"
  },
  "disposition": "no_direct_mapping",
  "relationships": [],
  "negative_rationale": "Missing outcome: CEPTS3.2-T4-001 - external result 'every cloud service' does not evidence ESAF outcome 'authentication of an identity before access to a non-public AI cloud asset'.",
  "mapper": {
