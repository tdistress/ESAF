---
{
  ...
  "context": {
    "mode": "paraphrase",
    "summary": "Have users of sampled devices attempt to sign in to organisational cloud services with organisation-issued accounts."
  },
  "source_locator": {
    ...
    "locator": "PDF page 17; printed page 16; Test description; sampled-user login sentence"
  },
  "disposition": "no_direct_mapping",
  "relationships": [],
  "negative_rationale": "Missing outcome: CEPTS3.2-T4-002 - external result 'attempt to sign in' does not evidence ESAF outcome 'observed authentication before access to a non-public AI cloud asset'.",
  "mapper": {
