---
{
  ...
  "context": {
    "mode": "paraphrase",
    "summary": "Configure the authorized external assessment site with filtering representative of other permitted sites."
  },
  "source_locator": {
    ...
    "locator": "PDF page 14; printed page 13; Test case 3; representative-filtering recommendation"
  },
  "disposition": "no_direct_mapping",
  "relationships": [],
  "negative_rationale": "Missing outcome: CEPTS3.2-T3-019 - external result 'filtering representative of other permitted sites' does not evidence ESAF outcome 'approved risk-proportionate network hardening baseline for AI workloads'.",
  "mapper": {
