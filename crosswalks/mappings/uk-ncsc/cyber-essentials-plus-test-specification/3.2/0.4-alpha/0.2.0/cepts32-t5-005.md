---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Repeat the exercise across all devices sampled for the audit."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 19; printed page 18; Test case 5; repetition step"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-T5-005 - external result \u0027all devices sampled for the audit\u0027 does not evidence ESAF outcome \u0027restriction and separate authentication of privileged access capable of changing enumerated AI assets\u0027.",
    "mapper":  {
