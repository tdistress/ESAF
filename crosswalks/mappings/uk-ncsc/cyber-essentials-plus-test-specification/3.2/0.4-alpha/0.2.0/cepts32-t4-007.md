---
{
  ...
  "context": {
    "mode": "paraphrase",
    "summary": "Repeat the access test for every authentication service in use."
  },
  "source_locator": {
    ...
    "locator": "PDF page 17; printed page 16; Test case 4; repetition step"
  },
  "disposition": "no_direct_mapping",
  "relationships": [],
  "negative_rationale": "Missing outcome: CEPTS3.2-T4-007 - external result 'every authentication service in use' does not evidence ESAF outcome 'observed risk-proportionate authentication result for each non-public AI access path'.",
  "mapper": {
