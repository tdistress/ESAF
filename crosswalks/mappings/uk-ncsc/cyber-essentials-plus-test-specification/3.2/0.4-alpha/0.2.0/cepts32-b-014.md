---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Use specific inert malware samples known to be detected by most common antivirus products."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 23; printed page 22; Appendix B: Types of test file; continued guidance, malware samples"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-B-014 - external result \u0027specific inert malware samples\u0027 does not evidence ESAF outcome \u0027an observed anti-malware detection result on an in-scope AI host\u0027.",
    "mapper":  {
