---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Encourage each Certification Body to customize the Assessor file subset for the Applicant."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 22; printed page 21; Note for Delivery Partner; tailoring recommendation"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-B-008 - external result \u0027customize the Assessor file subset\u0027 does not evidence ESAF outcome \u0027an observed malware or execution-control result for an in-scope AI host\u0027.",
    "mapper":  {
