---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Include routinely received file types, such as office documents, that contain inert malware samples."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 22; printed page 21; Appendix B: Types of test file; full-set list, routine file formats"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-B-012 - external result \u0027routinely received file types\u0027 does not evidence ESAF outcome \u0027an observed anti-malware result for a routine file on an in-scope AI host\u0027.",
    "mapper":  {
