---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Record an overall failure when neither pass route applies."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 20; printed page 19; Conclude the assessment; residual branch, assessment outcome"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-C-012 - external result \u0027overall failure\u0027 does not evidence ESAF outcome \u0027a specific evaluated security or governance result for an exact ESAF control\u0027.",
    "mapper":  {
