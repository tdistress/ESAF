---
{
  ...
  "context": {
    "mode": "paraphrase",
    "summary": "Alongside the common prerequisites, have a Delivery Partner-approved vulnerability scanner available."
  },
  "source_locator": {
    ...
    "locator": "PDF page 11; printed page 10; Prerequisites; test-specific prerequisite item"
  },
  "disposition": "no_direct_mapping",
  "relationships": [],
  "negative_rationale": "Missing outcome: CEPTS3.2-T2-002 - external result 'Delivery Partner-approved vulnerability scanner' does not evidence ESAF outcome 'identified vulnerability affecting AI infrastructure and its risk-based disposition'.",
  "mapper": {
