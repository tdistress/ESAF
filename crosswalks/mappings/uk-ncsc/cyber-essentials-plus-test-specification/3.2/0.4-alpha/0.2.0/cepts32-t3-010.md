---
{
  ...
  "context": {
    "mode": "paraphrase",
    "summary": "Determine the file types to cover in the email test."
  },
  "source_locator": {
    ...
    "locator": "PDF page 14; printed page 13; Test case 3; test-type selection"
  },
  "disposition": "no_direct_mapping",
  "relationships": [],
  "negative_rationale": "Missing outcome: CEPTS3.2-T3-010 - external result 'file types to cover' does not evidence ESAF outcome 'observed malware-file prevention result for an AI-supporting host or service'.",
  "mapper": {
