---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Define an Applicant-appropriate subset of the test-file set for the Assessor to use."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 22; printed page 21; Appendix B: Types of test file; subset-definition responsibility"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-B-002 - external result \u0027Applicant-appropriate subset of the test-file set\u0027 does not evidence ESAF outcome \u0027an observed malware or execution-control result for an in-scope AI host\u0027.",
    "mapper":  {
