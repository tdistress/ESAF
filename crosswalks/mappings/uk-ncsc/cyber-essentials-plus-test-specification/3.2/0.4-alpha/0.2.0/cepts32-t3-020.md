---
{
  ...
  "context": {
    "mode": "paraphrase",
    "summary": "Select test files appropriate to the operating system under test."
  },
  "source_locator": {
    ...
    "locator": "PDF page 15; printed page 14; Test case 3; operating-system file selection"
  },
  "disposition": "no_direct_mapping",
  "relationships": [],
  "negative_rationale": "Missing outcome: CEPTS3.2-T3-020 - external result 'test files appropriate to the operating system' does not evidence ESAF outcome 'observed executable or malware prevention state for an AI-supporting host'.",
  "mapper": {
