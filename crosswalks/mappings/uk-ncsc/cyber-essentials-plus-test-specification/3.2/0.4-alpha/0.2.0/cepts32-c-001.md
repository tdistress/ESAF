---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Compile the assessment report after all tests are completed."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 20; printed page 19; Conclude the assessment; opening report instruction"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-C-001 - external result \u0027Compile the assessment report\u0027 does not evidence ESAF outcome \u0027retained ESAF assessment evidence tied to scope, methods, results, findings, and remediation\u0027.",
    "mapper":  {
