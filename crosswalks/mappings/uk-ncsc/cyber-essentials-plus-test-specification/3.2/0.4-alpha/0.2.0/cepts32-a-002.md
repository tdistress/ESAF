---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Scan every IP address associated with the Applicant."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 21; printed page 20; Appendix A: Vulnerability scanning; second appendix item, address coverage"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-A-002 - external result \u0027every IP address associated with the Applicant\u0027 does not evidence ESAF outcome \u0027an identified vulnerability affecting AI infrastructure and its risk-based disposition\u0027.",
    "mapper":  {
