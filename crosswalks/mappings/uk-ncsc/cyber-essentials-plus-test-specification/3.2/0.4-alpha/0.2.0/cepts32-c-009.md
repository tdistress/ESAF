---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "After a discretionary overall pass, proceed with awarding the Plus certificate."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 20; printed page 19; Conclude the assessment; discretionary exception branch, certificate action"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-C-009 - external result \u0027awarding the Plus certificate\u0027 does not evidence ESAF outcome \u0027a specific evaluated security or governance result for an exact ESAF control\u0027.",
    "mapper":  {
