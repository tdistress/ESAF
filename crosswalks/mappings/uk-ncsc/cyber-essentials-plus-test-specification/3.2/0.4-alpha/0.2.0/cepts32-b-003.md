---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Host the Applicant-specific test-file subset."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 22; printed page 21; Appendix B: Types of test file; subset-hosting responsibility"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-B-003 - external result \u0027Host the Applicant-specific test-file subset\u0027 does not evidence ESAF outcome \u0027retained security-test evidence linked to an exact ESAF control result\u0027.",
    "mapper":  {
