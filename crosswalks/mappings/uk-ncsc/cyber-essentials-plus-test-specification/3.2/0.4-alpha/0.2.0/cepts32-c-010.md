---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Limit exceptional treatment to marginal deviations found in less than five percent of performed tests."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 20; printed page 19; Note for Delivery Partner; second note, first predicate"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-C-010 - external result \u0027marginal deviations\u0027 does not evidence ESAF outcome \u0027risk-based exception approval for an identified AI control deviation\u0027.",
    "mapper":  {
