---
{
  ...
  "context": {
    "mode": "paraphrase",
    "summary": "Record the outcome of each attempted attachment opening."
  },
  "source_locator": {
    ...
    "locator": "PDF page 14; printed page 13; Test case 3; result-recording clause"
  },
  "disposition": "no_direct_mapping",
  "relationships": [],
  "negative_rationale": "Missing outcome: CEPTS3.2-T3-014 - external result 'outcome of each attempted attachment opening' does not evidence ESAF outcome 'a defined malware-file access or execution state for an AI-supporting host or service'.",
  "mapper": {
