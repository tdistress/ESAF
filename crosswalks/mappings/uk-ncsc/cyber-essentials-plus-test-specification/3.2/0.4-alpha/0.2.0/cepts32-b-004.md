---
{
    ...
    "context":  {
                    "mode":  "paraphrase",
                    "summary":  "Confirm with the Certification Body that the correct files will be supplied for each test."
                },
    "source_locator":  {
                           ...
                           "locator":  "PDF page 22; printed page 21; Appendix B: Types of test file; correct-file check"
                       },
    "disposition":  "no_direct_mapping",
    "relationships":  [

                      ],
    "negative_rationale":  "Missing outcome: CEPTS3.2-B-004 - external result \u0027correct files will be supplied for each test\u0027 does not evidence ESAF outcome \u0027an observed malware or execution-control result for an in-scope AI host\u0027.",
    "mapper":  {
