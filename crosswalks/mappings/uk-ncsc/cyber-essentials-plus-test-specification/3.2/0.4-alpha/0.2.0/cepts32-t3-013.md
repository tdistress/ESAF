---
{
  ...
  "context": {
    "mode": "paraphrase",
    "summary": "Watch the user try to open each assessment attachment."
  },
  "source_locator": {
    ...
    "locator": "PDF page 14; printed page 13; Test case 3; attachment-opening observation"
  },
  "disposition": "no_direct_mapping",
  "relationships": [],
  "negative_rationale": "Missing outcome: CEPTS3.2-T3-013 - external result 'try to open each assessment attachment' does not evidence ESAF outcome 'observed malware-file access or execution result for an AI-supporting host or service'.",
  "mapper": {
