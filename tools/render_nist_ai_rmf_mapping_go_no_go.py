...
RIGHTS_REVIEW_PATH = (
    "docs/superpowers/reviews/2026-08-29-nist-ai-rmf-publication-rights-review.md"
)
...
QUESTION = (
    ...
    "recorded independently, without implying NIST AI RMF compliance, "
...
def _validate_reviewer_contract(value: object) -> None:
    ...
    if mapper != {
        ...
        "experience_required": ["NIST AI RMF 1.0", "ESAF-1600"],
    ...
    if (
        ...
        != "owner-approved NIST AI RMF subject-matter reviewer"
    ):
        raise ValueError("NIST AI RMF reviewer qualification is incomplete")
...
def validate_matrix(
    ...
    *,
    ...
    if (
        ...
        != "ai_rmf_core_subcategory_identifier"
    ):
...
def render(matrix: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "authorization to create a NIST AI RMF mapping.",
        "",
        ...
        "",
        "The official public NIST AI RMF 1.0 PDF digest, page count, and 72-subcategory "
    ...
    lines.extend(
        [
            ...
            "experience in NIST AI RMF 1.0 and ESAF-1600. The mapper may not review "
            "their own work.",
            "",
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Render the mechanically derived NIST AI RMF readiness decision."
    )
