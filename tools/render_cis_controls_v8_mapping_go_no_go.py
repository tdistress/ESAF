...
RIGHTS_REVIEW_PATH = (
    "docs/superpowers/reviews/2026-09-16-cis-controls-v8-publication-rights-review.md"
)
...
QUESTION = (
    ...
    "one authorized, publishable CIS Controls Version 8 Safeguard identifier, "
    "with each relationship's conditions, expected evidence, and known gaps "
    "recorded independently, without implying CIS Controls compliance, "
...
def _validate_reviewer_contract(value: object) -> None:
    ...
    if mapper != {
        ...
        "experience_required": ["CIS Controls Version 8", "ESAF-1600"],
    ...
    if (
        ...
        != "owner-approved CIS Controls Version 8 subject-matter reviewer"
    ):
        raise ValueError("CIS Controls Version 8 reviewer qualification is incomplete")
...
def validate_matrix(
    ...
    *,
    ...
    if (
        ...
        != "cis_controls_v8_safeguard_identifier"
    ):
...
def render(matrix: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "authorization to create a CIS Controls mapping.",
        "",
        ...
        "",
        "The official public CIS Controls Version 8 Safeguard inventory digest and "
        "153-identifier inventory are recorded in the source oracle. "
        "CIS Controls PDF and Excel package bytes are not committed to the repository.",
        "",
        "## Gate results",
        "",
    ...
    lines.extend(
        [
            ...
            "experience in CIS Controls Version 8 and ESAF-1600. The mapper may not "
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Render the mechanically derived CIS Controls Version 8 readiness decision."
    )
