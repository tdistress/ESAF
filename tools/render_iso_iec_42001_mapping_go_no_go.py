...
def _validate_reviewer_contract(value: object) -> None:
    ...
    if (
        ...
        raise ValueError("ISO/IEC 42001 reviewer qualification is incomplete")
...
def render(matrix: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "authorization to create an ISO/IEC 42001 mapping.",
        "",
        ...
        "",
        "The protected ISO/IEC 42001:2023 source artifact, its digest, and its provision "
    ...
    lines.extend(
        [
            ...
            "experience in ISO/IEC 42001:2023 and ESAF-1600. The mapper may not review "
            "their own work.",
            "",
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Render the mechanically derived ISO/IEC 42001:2023 readiness decision."
    )
