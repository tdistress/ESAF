...
## ISO/IEC 27001 readiness validation

Validate the closed ISO/IEC 27001:2022 readiness matrix, derive the GO/HOLD
decision, and require the generated review to match without rewriting it:
...
Validate the current v0.12-draft readiness record without changing files:
...
```shell
python tools/v012_draft_release_gates.py --check --baseline-ref <baseline-sha>
```

Validate the current v0.13-draft readiness record without changing files:
...
Validate the current v0.15-draft readiness record without changing files:
...
```shell
python tools/v015_draft_release_gates.py --check --baseline-ref <baseline-sha>
```

Validate the current v0.16-draft readiness record without changing files:
...
```shell
python tools/v016_draft_release_gates.py --check --baseline-ref <baseline-sha>
```

Validate the current v0.17-draft readiness record without changing files:
