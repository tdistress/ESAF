...
DEFAULT_OUTPUT = (
    ...
    / "superpowers"
    / "reviews"
    / "2026-09-16-nist-sp-800-53-rev5-mapping-go-no-go-review.md"
)
RIGHTS_REVIEW_PATH = (
    "docs/superpowers/reviews/2026-09-16-nist-sp-800-53-publication-rights-review.md"
)
...
QUESTION = (
    ...
    "one authorized, publishable NIST SP 800-53 Revision 5 control or "
    "control-enhancement identifier, with each relationship's conditions, "
    "expected evidence, and known gaps recorded independently, without implying "
    "NIST SP 800-53 compliance, assessment, equivalence, certification, "
...
def _validate_reviewer_contract(value: object) -> None:
    ...
    if mapper != {
        ...
        "experience_required": ["NIST SP 800-53 Rev. 5", "ESAF-1600"],
    ...
    if (
        ...
        != "owner-approved NIST SP 800-53 subject-matter reviewer"
    ):
        raise ValueError("NIST SP 800-53 reviewer qualification is incomplete")
...
def validate_matrix(
    ...
    *,
    ...
    if (
        ...
        != "nist_sp_800_53_rev5_control_or_enhancement_identifier"
    ):
...
def render(matrix: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "authorization to create a NIST SP 800-53 mapping.",
        "",
        ...
        "",
        "The official public NIST SP 800-53 Rev. 5 PDF digest, page count, and "
        "1196-identifier control/enhancement inventory are recorded in the source oracle. "
        "PDF and OSCAL catalog bytes are not committed to the repository.",
        "",
        "## Gate results",
        "",
    ...
    lines.extend(
        [
            ...
            "experience in NIST SP 800-53 Rev. 5 and ESAF-1600. The mapper may not "
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Render the mechanically derived NIST SP 800-53 readiness decision."
    )
