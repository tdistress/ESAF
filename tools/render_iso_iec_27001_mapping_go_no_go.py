...
def _validate_reviewer_contract(value: object) -> None:
    ...
    if (
        ...
        raise ValueError("ISO/IEC 27001 reviewer qualification is incomplete")
...
def render(matrix: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "authorization to create an ISO/IEC 27001 mapping.",
        "",
        ...
        "",
        "The protected ISO/IEC 27001:2022 source artifact, its digest, and its provision "
        "inventory remain unavailable. Public discovery metadata is not a substitute for "
        "source bytes.",
        "",
        "## Gate results",
        "",
    ...
    lines.extend(
        [
            ...
            "experience in ISO/IEC 27001:2022 and ESAF-1600. The mapper may not review "
            "their own work.",
            "",
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Render the mechanically derived ISO/IEC 27001:2022 readiness decision."
    )
