...
COMMAND_CATALOG = (
    ...
    ValidationCommand("iso-iec-27001-mapping-go-no-go", ("python", "tools/render_iso_iec_27001_mapping_go_no_go.py", "--check"), "publication", "candidate freeze"),
    ...
    ValidationCommand("nist-csf-mapping-go-no-go", ("python", "tools/render_nist_csf_mapping_go_no_go.py", "--check"), "publication", "candidate freeze"),
    ValidationCommand("nist-sp-800-53-mapping-go-no-go", ("python", "tools/render_nist_sp_800_53_mapping_go_no_go.py", "--check"), "publication", "candidate freeze"),
    ValidationCommand("cis-controls-v8-mapping-go-no-go", ("python", "tools/render_cis_controls_v8_mapping_go_no_go.py", "--check"), "publication", "candidate freeze"),
...
PUBLICATION_COMMAND_IDS = (
    ...
    "iso-iec-42001-mapping-go-no-go", "iso-iec-27001-mapping-go-no-go",
    "nist-ai-rmf-mapping-go-no-go", "nist-csf-mapping-go-no-go",
    "nist-sp-800-53-mapping-go-no-go",
    "cis-controls-v8-mapping-go-no-go",
